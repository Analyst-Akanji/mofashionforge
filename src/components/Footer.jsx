    ...
    <footer style={{ background: "#0F0F0F", borderTop: "1px solid rgba(184,151,58,0.2)", padding: "48px 24px 32px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "48px", marginBottom: "48px" }}>
          ...
          <div>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#B8973A", marginBottom: "16px", marginTop: 0 }}>Shop</p>
            {["Earrings", "Bucket Hats", "Tops", "Sweatshirts", "Accessories", "Limited Edition"].map(item => (
          ...
          <div>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#B8973A", marginBottom: "16px", marginTop: 0 }}>Pages</p>
          ...
          <div>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#B8973A", marginBottom: "16px", marginTop: 0 }}>Info</p>
            {["FAQ", "Shipping Policy", "Returns Policy", "Privacy Policy"].map(item => (
              <p key={item} style={{ fontFamily: "Inter, sans-serif", fontSize: "13px", color: "rgba(250,248,243,0.55)", marginBottom: "10px", marginTop: 0 }}>{item}</p>
            ))}
          </div>
        </div>
