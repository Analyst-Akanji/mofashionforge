  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5F5F5", fontFamily: "Inter, sans-serif" }}>
      ...
      <div style={{
        ...
        background: "#0F0F0F", height: "56px",
        alignItems: "center", justifyContent: "space-between",
        padding: "0 16px",
        borderBottom: "1px solid rgba(184,151,58,0.2)",
      }} className="mobile-topbar">
        <p style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "1.1rem", color: "#FAF8F3", margin: 0 }}>
          {currentPage}
        </p>
        <button
          onClick={() => setMobileOpen(v => !v)}
          style={{ background: "none", border: "none", cursor: "pointer", color: "#FAF8F3", fontSize: "22px", padding: "4px 8px", lineHeight: 1 }}
        >
          {mobileOpen ? "✕" : "☰"}
        </button>
      </div>
      ...
      {mobileOpen && (
        <div style={{
          ...
          background: "#0F0F0F", borderBottom: "1px solid rgba(184,151,58,0.2)",
          padding: "8px 0 16px",
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  color: active ? "#B8973A" : "rgba(250,248,243,0.75)",
                  textDecoration: "none",
                  background: active ? "rgba(184,151,58,0.08)" : "transparent",
                  borderLeft: active ? "3px solid #B8973A" : "3px solid transparent",
                }}
              >
          ...
          <div style={{ margin: "12px 20px 0", paddingTop: "12px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <button onClick={logout} style={{ fontFamily: "Inter, sans-serif", fontSize: "12px", letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(250,248,243,0.5)", background: "none", border: "1px solid rgba(255,255,255,0.1)", cursor: "pointer", padding: "8px 16px" }}>
              Sign Out
            </button>
          </div>
        </div>
      ...
      {/* ── Main content ── */}
      <main style={{ marginLeft: "220px" }} className="admin-main">
        {children}
      </main>
